...
def main():
    ...
    parser.add_argument("--domain", required=True, help="The zone domain (e.g., dasbaum.ch)")
    parser.add_argument("--name", required=True, help="Full record name (e.g., _25._tcp.mail.dasbaum.ch)")
    parser.add_argument("--type", required=True, help="Record type (e.g., TLSA, TXT, A, AAAA, CAA)")
    parser.add_argument("--value", required=True, help="The new content/value for the record")

    # Optional: allow path to config file
    parser.add_argument("--config", default="iway-certbot-dns-auth.yml", help="Path to YAML config")
